    ...
    switch ( appData.state )
    {
        ...
        case APP_STATE_MOUSE_EMULATE:
            ...
            if(appData.emulateMouse)
            {
                ...
                x_pos=((float) 8)*((float) accels[0])/ ((float) 16000);
                y_pos=((float) 8)*((float) accels[1])/ ((float) 16000);
                _CP0_SET_COUNT(0);
                while(_CP0_GET_COUNT() < CYCLES){
                ;
                }
                sprintf(message,"x: %.2f  y: %.2f",x_pos, y_pos);
                ...
                if(movement_length > 50)
                {
                    ...
                    appData.xCoordinate =x_pos ;
                    appData.yCoordinate =y_pos ;
